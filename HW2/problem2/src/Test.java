...
public class Test {
    ...
    static void testSubproblemB() {
        ...
        System.out.println("Should be 2480.0 : " + market.buyers.get(500).getExpectedPrice());
        System.out.println("Should be 2495.0 : " + market.buyers.get(999).getExpectedPrice());
        System.out.println("Should be 2500.0 : " + market.sellers.get(0).getExpectedPrice());
        System.out.println("Should be 2500.0 : " + market.sellers.get(500).getExpectedPrice());
        System.out.println("Should be 2495.0 : " + market.buyers.get(999).getExpectedPrice());
    }
    ...
    static void testSubproblemC() {
        ...
        System.out.printf("Should be 2332.91228 : %.5f", price);
    }
